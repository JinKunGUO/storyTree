...
StoryTree 采用 **Business Source License 1.1 (BSL 1.1)** 许可协议。

### 对贡献者的影响

- 你提交的所有代码将受 BSL 1.1 协议约束
- 你保留自己所贡献代码的版权，但授权项目所有者在 BSL 1.1 及其 Change License (AGPL-3.0) 下使用
- 你同意你的贡献可以在未来商业版本中使用

### 对使用者的限制

在 Change Date (2029-06-22) 之前：

- ✅ 允许：个人学习、内部使用、教育研究、提交贡献
- ❌ 禁止：将 StoryTree 作为商业竞品服务运营、白标/OEM 产品
- 💼 商业使用：如需将 StoryTree 用于商业竞品场景，请联系 storytree.license@gmail.com 获取商业许可

Change Date 之后，代码将自动转为 AGPL-3.0 协议。

### 贡献者许可协议 (CLA)

提交代码即表示你同意：

1. 你拥有所提交代码的版权，或有合法授权
2. 你授权项目在 BSL 1.1 和 AGPL-3.0 双重许可下使用你的贡献
3. 你的贡献不侵犯任何第三方的知识产权
